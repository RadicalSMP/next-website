...
export default function FormBuilderEditPage() {
    ...
    return (
        <div className="space-y-6 max-w-4xl">
            {/* 页面标题 */}
            <div>
                <h1 className="text-3xl font-bold tracking-tight">编辑表单</h1>
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="grid gap-2">
                            ...
                            <Input
                                id="slug"
                                placeholder="例如：join-application"
                                value={slug}
                                ...
                                <div className="grid grid-cols-3 gap-3">
                                    <div className="grid gap-1.5">
                                        ...
                                        <Input
                                            ...
                                            onChange={(e) => {
                                                ...
                                                if (field.key.startsWith("field_")) {
                                                    updates.key = generateKey(label);
                                                }
                                    ...
                                    <div className="grid gap-1.5">
                                        ...
                                        <Select
                                            value={field.type}
                                            onValueChange={(v) =>
                                                updateField(index, { type: v as FormField["type"] })
                                            }
                                        >
                                            <SelectTrigger>
                                                <SelectValue />
